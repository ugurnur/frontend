...
class EmailSignupController(wsClient: WSClient)(implicit context: ApplicationContext, val controllerComponents: ControllerComponents) extends BaseController with ExecutionContexts with Logging {
